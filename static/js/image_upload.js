...
imageNoteButton.addEventListener('click', (evt) => {
  ...
  imageNoteUploader.innerHTML = '<p style="font-size: 12px">This is for uploading an image as a note and will override anything written in the body textbox.</p><br/><input type="file" name="note-image" id="note-image-body" accept="image/*">'
});
...
imageAttachmentButton.addEventListener('click', (evt) => {
  ...
  imageAttachmentUploader.innerHTML = '<p style="font-size: 12px">This is for attaching an image to a note.</p><br/><input type="file" name="note-attachment" id="note-image-attachment" accept="image/*">'
});
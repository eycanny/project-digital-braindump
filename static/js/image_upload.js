...
imageNoteButton.addEventListener('click', (evt) => {
  ...
  imageNoteUploader.innerHTML = '<br/>This is for uploading an image as a note and will override anything written in the body textbox.<br/><input type="file" name="note-image" id="note-image-body" accept="image/*">'
});
...
imageAttachmentButton.addEventListener('click', (evt) => {
  ...
  imageAttachmentUploader.innerHTML = '<br/>This is for attaching an image to a note.<br/><input type="file" name="note-attachment" id="note-image-attachment" accept="image/*">'
});